...
Param(
    ...
    [string] $ResourceGroupName = 'HotelBookingSystem-Azure',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = 'HBS.SendEmailAlert.json',
    [string] $TemplateParametersFile = 'HBS.SendEmailAlert.parameters.json',
